...
#define MyAppName "QuestionIV Core"
#define MyAppPublisher "2022 DECENOMY Core Developers"
#define MyAppURL "https://QuestionIV.com"
#define MyAppExeName "QuestionIV-qt.exe"
#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/QIV/bootstrap.zip"
...
DefaultDirName={autopf}\QuestionIV
...
OutputDir=.\output
OutputBaseFilename=QuestionIVSetup
...
DefaultGroupName=QuestionIV Core
...
[Files]
Source: ".\package\QuestionIV-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\QuestionIV\QuestionIV-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\QuestionIV\QuestionIV-Qt,strDataDir|{userappdata}\QuestionIV\}');
  Result := True;
end;
