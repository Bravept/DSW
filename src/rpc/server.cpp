...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop QuestionIV server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "QuestionIV server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* QIV features */
        {"QuestionIV", "listmasternodes", &listmasternodes, true },
        {"QuestionIV", "getmasternodecount", &getmasternodecount, true },
        {"QuestionIV", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"QuestionIV", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"QuestionIV", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"QuestionIV", "masternodecurrent", &masternodecurrent, true },
        {"QuestionIV", "startmasternode", &startmasternode, true },
        {"QuestionIV", "createmasternodekey", &createmasternodekey, true },
        {"QuestionIV", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"QuestionIV", "listmasternodeconf", &listmasternodeconf, true },
        {"QuestionIV", "getmasternodestatus", &getmasternodestatus, true },
        {"QuestionIV", "getmasternodewinners", &getmasternodewinners, true },
        {"QuestionIV", "getmasternodescores", &getmasternodescores, true },
        {"QuestionIV", "mnsync", &mnsync, true },
        {"QuestionIV", "spork", &spork, true },
...
{
    return "> QuestionIV-cli " + methodname + " " + args + "\n";
}
