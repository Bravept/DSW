...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("QuestionIV QuestionIV-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  QuestionIV-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded QuestionIV transaction") + "\n" +
                               "  QuestionIV-tx [options] -create [commands]   " + _("Create hex-encoded QuestionIV transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded QuestionIV transaction
