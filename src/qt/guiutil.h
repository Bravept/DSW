...
/** Utility functions used by the QuestionIV Qt UI.
 */
namespace GUIUtil
{
...
// Render QIV addresses in monospace font
...
// Parse "QuestionIV:" URI into recipient object, return true on successful parsing
