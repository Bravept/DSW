...
/* QuestionIV GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "QuestionIV"
#define QAPP_ORG_DOMAIN "QuestionIV.org"
#define QAPP_APP_NAME_DEFAULT "QuestionIV-Qt"
#define QAPP_APP_NAME_TESTNET "QuestionIV-Qt-testnet"
