...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("QuestionIV"),
     ...
     * override -datadir in the QuestionIV.conf file in the default data directory
     * (to be consistent with QuestionIVd behavior)
     */
