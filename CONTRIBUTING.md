Contributing to QuestionIV Core
============================

The QuestionIV Core project operates an open contributor model where anyone is
...
The following applies to code changes to the QuestionIV Core project, and is not to be
confused with overall QuestionIV Network Protocol consensus changes.

Whether a pull request is merged into QuestionIV Core rests with the project merge
...
Patches that change QuestionIV consensus rules are considerably more involved than
...
Where a patchset proposes to change the QuestionIV consensus, it must have been
...
The project leader is the release manager for each QuestionIV Core release.
