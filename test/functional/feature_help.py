...
"""Verify that starting QuestionIV with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start QuestionIV with -? for help text")
        ...
        self.log.info("Start QuestionIV with -version for version information")
