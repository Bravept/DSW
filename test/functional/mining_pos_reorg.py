...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected QIV supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check QIV supply at the beginning
        # ------------------------------------------
        # QIV supply: block rewards minus burned fees for minting
        ...
        # Verify that QIV supplies were properly updated after the spends and reorgs
        self.log.info("Check QIV supply...")
